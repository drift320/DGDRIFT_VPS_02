...
DEFAULT_CONFIG = {
    ...
    "passwords": {
        "secret": hashlib.sha256("DRIFTXADMIN24".encode()).hexdigest(),
...
async def api_check(message: types.Message):
    ...
    try:
        ...
        r = requests.get(url, timeout=15, headers={
            'User-Agent': 'Mozilla/5.0 (DRIFT VPS Bot)'
        })
...
if __name__ == "__main__":
    ...
    print("  Secret: DRIFTXADMIN24 (Can change user password)")
